...
[<img src="kicad/thumb/pcb-2.png" width="300">](kicad/pcb-2.png)[<img src="kicad/thumb/pcb-1.png" width="300">](kicad/pcb-1.png)

# Gerbers

- [gerbers.zip](kicad/gerbers.zip) - main PCB
- [gerbers-pots.zip](kicad_pot_daughterboard/gerbers-pots.zip) - pot daugterboards (you can also use perfboard or stripboard)
...
- Solder 4 pots on their adapter boards. Before you solder them make sure that 3PDT switch have enough thread for given pot height.
    ...
    [<img src="photo/build/autowah_pots.jpg" width="300">](photo/build/autowah_pots.jpg) [<img src="kicad_pot_daugterboard/thumb/pot.png">](kicad_pot_daugterboard/pot.png)
